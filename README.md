...
- `Restore exported CSV` restores the existing `Web/review_exports/review_restore_export.csv` back into the reviewed ROI/lane/annotation CSV files. Use this after resetting images if you need to recover the last exported restore snapshot.
